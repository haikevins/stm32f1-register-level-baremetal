...
} stm32_adc_registers_t;

typedef struct
{
    volatile const uint32_t ISR;
    volatile uint32_t IFCR;
} stm32_dma_registers_t;
...
#define STM32_ADC1   ((stm32_adc_registers_t *)STM32_ADC1_BASE)
#define STM32_USART1 ((stm32_usart_registers_t *)STM32_USART1_BASE)
#define STM32_TIM2   ((stm32_timer_registers_t *)STM32_TIM2_BASE)
#define STM32_TIM3   ((stm32_timer_registers_t *)STM32_TIM3_BASE)
#define STM32_I2C1   ((stm32_i2c_registers_t *)STM32_I2C1_BASE)

#define STM32_DMA1    ((stm32_dma_registers_t *)STM32_DMA1_BASE)
#define STM32_DMA1_CHANNEL1 \
    ((stm32_dma_channel_registers_t *)(STM32_DMA1_BASE + UINT32_C(0x0008)))
