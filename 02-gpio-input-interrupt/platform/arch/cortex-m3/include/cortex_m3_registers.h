...
#define CORTEX_M3_NVIC_BASE    (UINT32_C(0xE000E100))
...
#define CORTEX_M3_NVIC \
    ((cortex_m3_nvic_registers_t *)CORTEX_M3_NVIC_BASE)
#define CORTEX_M3_SCB \
    ((cortex_m3_scb_registers_t *)CORTEX_M3_SCB_BASE)
