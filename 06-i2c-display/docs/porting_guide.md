# 06 I2C display - Porting Guide

> **Purpose:** identify which assumptions in `06-i2c-display` are board-specific, STM32F103-specific, Cortex-M3-specific, or application policy before changing hardware.
...
|---|---|
| Display address | module strap: usually 0x3C or 0x3D |
| I2C pins | AF mapping/remap, open-drain mode, external pull-ups |
| PCLK1 | CCR/TRISE calculation and STM32F1 36 MHz I2C input limit |
| Panel geometry | framebuffer size, multiplex/COM configuration, drawing bounds |
| Controller variant | initialization commands and addressing model |
| Recovery policy | bus clear/reset/retry requirements for production use |
| SRAM budget | 1024-byte framebuffer plus stack/static growth |
...
[← Architecture](architecture.md) · [↑ Example README](../README.md) · [07 SPI memory →](../../07-spi-memory/README.md)
